...
class Transaction_Master_Info_Model extends CI_Model  {
   ...
   function get_rowByPK($companyID,$transactionID,$transactionMasterID){    
		$this->db->select("companyID,transactionID,transactionMasterID,zoneID,routeID,referenceClientName,referenceClientIdentifier,receiptAmount,receiptAmountDol,reference1,reference2");
