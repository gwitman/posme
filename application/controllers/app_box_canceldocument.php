...
class App_Box_Canceldocument extends CI_Controller {
    ...
    function edit(){ 
		 ...
		 try{ 
			...
			{ 
				...
				redirect('app_box_canceldocument/add');	
			...
			$dataSession["head"]			= $this->load->view('app_box_canceldocument/edit_head',$dataView,true);

			$dataSession["body"]			= $this->load->view('app_box_canceldocument/edit_body',$dataView,true);

			$dataSession["script"]			= $this->load->view('app_box_canceldocument/edit_script',$dataView,true);
	...
	function updateElement($dataSession){
		...
		try{
			...
			if($this->db->trans_status() !== false){
				...
				redirect('app_box_canceldocument/edit/companyID/'.$companyID."/transactionID/".$transactionID."/transactionMasterID/".$transactionMasterID);
	...
	function insertElement($dataSession){
		...
		try{
			...
			if($this->db->trans_status() !== false){
				...
				redirect('app_box_canceldocument/edit/companyID/'.$companyID."/transactionID/".$objTM["transactionID"]."/transactionMasterID/".$transactionMasterID);
	...
	function add(){ 
		...
		try{ 
			...
			$dataSession["head"]			= $this->load->view('app_box_canceldocument/news_head',$dataView,true);

			$dataSession["body"]			= $this->load->view('app_box_canceldocument/news_body',$dataView,true);

			$dataSession["script"]			= $this->load->view('app_box_canceldocument/news_script',$dataView,true);  
	...
	function index($dataViewID = null){	
		...
		try{ 
			...
			$dataSession["head"]			= $this->load->view('app_box_canceldocument/list_head','',true);

			$dataSession["footer"]			= $this->load->view('app_box_canceldocument/list_footer','',true);

			$dataSession["body"]			= $dataViewRender; 

			$dataSession["script"]			= $this->load->view('app_box_canceldocument/list_script','',true).$this->core_web_javascript->createVar("componentID",$objComponent->componentID);  
	...
	function viewRegister(){
		...
		try{ 
			...
			$pdf->EXTCreateHeader("::".$objCompany->name." CANCELACION DE FACTURA"."::",$objComponent->componentID,$objParameter->value,$dataSession);
