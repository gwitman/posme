    ...
    function Cezpdf($paper='a4',$orientation='portrait', $type = 'none', $options = array()){
        if (!is_array($paper)){
            switch (strtoupper($paper)){						
                ...
                case 'LETTER': {$size = array(0,0,612.00 /*ancho*/,792.00 /*alto*/); break;} /*cm 1 = 27.8181 point*/
				...
				//paper para imprestora termica, de 8cm o 3.2 pulgadas o
				//impresora de ticket con las mismas medidas
				case 'INVOICE_PRINTER_TERMICA_001': {$size = array(0,0,222.55 /*ancho*/,2500 /*alto*/); break;} 
				case 'ITEM_PRINTER_CODBAR': {$size = array(0,0,222.55/*ancho 5.5cm*/,2500/*alto 2.5cm*/); break;} 
