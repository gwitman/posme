				...
				<script>					
					...
					$(document).ready(function(){	
						...
						$(document).on("click","#btnDelete",function(){
							fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
								...
								$.ajax({									
									...
									dataType    : 'json',
									type        : 'POST',
									url  		: "<?php echo site_url(); ?>app_rrhh_employee/delete",
									...
									success:function(data){
										...
										if(data.error){
											...
											window.location = "<?php echo site_url(); ?>app_rrhh_employee/index";
										}
									},
						...
						$(document).on("click","#btnClickArchivo",function(){
							window.open("<?php echo site_url()."core_elfinder/index/componentID/".$objComponent->componentID."/componentItemID/".$objEmployee->entityID; ?>","blanck");
						});
						//Evento Agregar el Usuario
						$(document).on("click","#btnAcept",function(){
								$( "#form-new-rrhh-employee" ).attr("method","POST");
								$( "#form-new-rrhh-employee" ).attr("action","<?php echo site_url(); ?>app_rrhh_employee/save/edit");
						...
						$(document).on("click","#btnSearchEmployeeParent",function(){
							var url_request = "<?php echo site_url(); ?>core_view/showviewbyname/<?php echo $objComponent->componentID; ?>/onCompleteEmployee/SELECCIONAR_EMPLOYEE/true/empty";
