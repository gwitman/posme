	...
	$(document).ready(function(){		
		...
		$(document).on("click","#btnEdit",function(){
			...
			if(objRowTableListView != undefined){
				...
				window.location	= "<?php echo site_url(); ?>app_accounting_currency/edit/companyID/"+data[0]+"/currencyID/"+data[1];
			...
			if(objRowTableListView != undefined){
				...
				fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
					...
					$.ajax({									
						...
						url  		: "<?php echo site_url(); ?>app_accounting_currency/delete",
		...
		$(document).on("click","#btnNuevo",function(){
			...
			window.location	= "<?php echo site_url(); ?>app_accounting_currency/add.aspx";
