...
<html lang="en">
	...
	<body style="font-family:monospace;font-size:smaller;margin:0px 0px 0px 0px"> 
		...
		helper_header(
			'ESTADO DE CUENTA',
			$objCompany->name,18,'ESTADO DE CUENTA DEL CLIENTE '.$objClient["customerNumber"],
			"",
			"",'2700px'
		);
		?>
		...
		$objClient;
		helper_createTableReportVertical($objClient,$configColumn1,18,'2700px');
		?>
		...
		helper_createTableReport($objDocument,$configColumn,'2700px');
		?>
		...
		<br/>		
		<?php 
		helper_echoFirma($objFirmaEncription,18,'2700px');
		?>
