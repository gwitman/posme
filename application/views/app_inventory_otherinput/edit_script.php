...
<script>	
	...
	$(document).ready(function(){					
		...
		$(document).on("click","#btnPrinter",function(){
			fnWaitOpen();							
			window.location = "<?php echo site_url(); ?>app_inventory_otherinput/viewRegister/companyID/<?php echo $objTM->companyID;?>/transactionID/<?php echo $objTM->transactionID;?>/transactionMasterID/<?php echo $objTM->transactionMasterID;?>";
		});
				...
				$.ajax({									
					...
					success:function(data){
						...
						if(data.error){
							...
							window.location = "<?php echo site_url(); ?>app_inventory_otherinput/index";
						}
					},
		...
		$(document).on("click","#btnAcept",function(){
				...
				$( "#form-new-transaction" ).attr("action","<?php echo site_url(); ?>app_inventory_otherinput/save/edit");
