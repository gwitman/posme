				...
				<script>		
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-invoice" ).attr("action","<?php echo site_url(); ?>app_box_sharecapital/save/edit");
								...
								$.ajax({									
									...
									success:function(data){
										...
										if(data.error){
											...
											window.location = "<?php echo site_url(); ?>app_box_sharecapital/index";
										}
									},
						...
						$(document).on("click","#btnClickArchivo",function(){
							window.open("<?php echo site_url()."core_elfinder/index/componentID/".$objComponentTransactionShareCapital->componentID."/componentItemID/".$objTransactionMaster->transactionMasterID; ?>","blanck");
						});
