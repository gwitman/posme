...
<script>	
	...
	$(document).ready(function(){					
		...
		$(document).on("click","#btnPrinter",function(){
			fnWaitOpen();							
			window.location = "<?php echo site_url(); ?>app_inventory_transferoutput/viewRegister/companyID/<?php echo $objTM->companyID;?>/transactionID/<?php echo $objTM->transactionID;?>/transactionMasterID/<?php echo $objTM->transactionMasterID;?>";
		});
		...
		$(document).on("click","#btnDelete",function(){
			fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
				...
				$.ajax({									
					...
					dataType    : 'json',
					type        : 'POST',
					url  		: "<?php echo site_url(); ?>app_inventory_transferoutput/delete",
					...
					success:function(data){
						...
						if(data.error){
							...
							window.location = "<?php echo site_url(); ?>app_inventory_transferoutput/index";
						}
					},
		...
		$(document).on("click","#btnAcept",function(){
				...
				$( "#form-new-transaction" ).attr("action","<?php echo site_url(); ?>app_inventory_transferoutput/save/edit");
		...
		$(document).on("click","#btnNewDetailTransaction",function(){							
			...
			var url_request	= "<?php echo site_url(); ?>core_view/showviewbyname/<?php echo $componentItemID; ?>/onCompleteItem/SELECCIONAR_ITEM_TO_TRANSFEROUPUT/true/"+encodeURI("{\"warehouseSourceID\"|\""+$("#txtWarehouseSourceID").val()+"\"{}\"warehouseTargetID\"|\""+$("#txtWarehouseTargetID").val()+"\"{}\"userID\"|\"<?php echo $userID; ?>\"}");
