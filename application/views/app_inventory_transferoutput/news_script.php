...
<script>	
	...
	$(document).ready(function(){					
		...
		$(document).on("click","#btnNewDetailTransaction",function(){
			...
			var url_request	= "<?php echo site_url(); ?>core_view/showviewbyname/<?php echo $componentTranItemID; ?>/onCompleteItem/SELECCIONAR_ITEM_TO_TRANSFEROUPUT/"+encodeURI("{\"warehouseSourceID\"|\""+$("#txtWarehouseSourceID").val()+"\"{}\"warehouseTargetID\"|\""+$("#txtWarehouseTargetID").val()+"\"{}\"userID\"|\"<?php echo $userID; ?>\"}");
