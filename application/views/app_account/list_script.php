	...
	$(document).ready(function(){		
		...
		$(document).on("click","#btnEdit",function(){
			...
			if(objRowTableListView != undefined){
				...
				window.location	= "<?php echo site_url(); ?>app_accounting_account/edit/companyID/"+data[0]+"/accountID/"+data[1];
			}
			else{
		...
		$(document).on("click","#btnNuevo",function(){
			fnWaitOpen();
			window.location	= "<?php echo site_url(); ?>app_accounting_account/add.aspx";
		});
	});
