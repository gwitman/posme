	...
	$(document).ready(function(){	
		...
		$(document).on("click","#btnEdit",function(){
			...
			if(objRowTableListView != undefined){
				...
				window.location	= "<?php echo site_url(); ?>app_cxp_provider/edit/companyID/"+data[0]+"/branchID/"+data[1]+"/entityID/"+data[2];
			}
			else{
		...
		$(document).on("click","#btnNuevo",function(){
			fnWaitOpen();
			window.location	= "<?php echo site_url(); ?>app_cxp_provider/add.aspx";
		});
	});
