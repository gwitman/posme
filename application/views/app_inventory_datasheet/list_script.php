	...
	$(document).ready(function(){	
		...
		$(document).on("click","#btnEdit",function(){
			...
			if(objRowTableListView != undefined){
				...
				fnWaitOpen();				
				window.location	= "<?php echo site_url(); ?>app_inventory_datasheet/edit/companyID/"+data[0]+"/itemDataSheetID/"+data[1];
			}
			else{
		...
		$(document).on("click","#btnSearchItem",function(){
					...
					$.ajax({									
						...
						dataType    : 'json',
						type        : 'POST',
						url  		: "<?php echo site_url(); ?>app_inventory_datasheet/searchItem",
						...
						success:function(data){
							...
							if(data.error){
								...
								window.location = "<?php echo site_url(); ?>app_inventory_datasheet/edit/itemID/"+data.itemID+"/itemDataSheetID/"+data.itemDataSheetID;
							}
						},
			...
			if(objRowTableListView != undefined){
				...
				fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
					...
					$.ajax({									
						...
						dataType    : 'json',
						type        : 'POST',
						url  		: "<?php echo site_url(); ?>app_inventory_datasheet/delete",
		...
		$(document).on("click","#btnNuevo",function(){
			fnWaitOpen();
			window.location	= "<?php echo site_url(); ?>app_inventory_datasheet/add.aspx";
		});
	});
