				...
				<script>		
					...
					$(document).ready(function(){
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-account-journal" ).attr("action","<?php echo site_url(); ?>app_inventory_datasheet/save/edit"); 
						...
						objItemDataSheetDetail = $("#tb_item_data_sheet_detail").dataTable({
							...
							"aoColumnDefs": [ 
										...
										},
										{
											...
											"bSearchable"	: false,
											"mRender"		: function ( data, type, full ) {
												return '<input type="hidden" value="'+data+'" name="txtItemDataSheetID[]" />';
											}
										},
										{
											"aTargets"		: [2],//itemID
										...
										},
										{
											...
											"bSearchable"	: false,
											"mRender"		: function ( data, type, full ) {
												return '<input type="hidden" value="'+data+'" name="txtItemDataSheetDetailID[]" />';
											}
										},
										{
											...
											"bSearchable"	: false,
											"mRender"		: function ( data, type, full ) {
												return '<input type="hidden" value="'+data+'" name="txtItemRelatedID[]" />';
											}
										},
										{
											"aTargets"	: [ 8 ],//cantidad
