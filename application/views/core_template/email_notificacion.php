												...
												<tr>
													<td align="center"
														...
														<table class="es-header-body"
															...
															<tr>
																<td align="left"
																    style="padding:20px;Margin:0;border-radius:10px 10px 0px 0px;background-color:#ffffff"
																    bgcolor="#fff">
																	<table cellpadding="0"
																	       cellspacing="0"
																	       width="100%"
																				...
																				<table cellpadding="0"
																					...
																					<tr>
																						<td align="left"
																							...
																							<a target="_blank"
																							   href="https://www.facebook.com/people/Posme-Nicaragua/100085567321314"
																							   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#3D7781;font-size:14px">
																								<img src="https://yjqvnr.stripocdn.email/content/guids/CABINET_826ea6673a309bf3e52069b2006b1106c5923eb90580483c6575f6fb2c779909/images/logo_png2x.png"
																								     alt="Logo"
																						...
																						<tr>
																							<td align="center"
																								...
																								<h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:georgia, times, 'times new roman', serif;font-size:30px;font-style:normal;font-weight:normal;color:#023047">
																									<strong><?php echo $title1; ?></strong>
																									<br><?php echo $title2; ?></h1>
																								</td>
																							</tr>
																							<tr>
																								<td align="center"
																									...
																									<a target="_blank"
																									   ...
																									   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#3D7781;font-size:14px">
																										<img class="adapt-img"
																										     src="https://yjqvnr.stripocdn.email/content/guids/CABINET_826ea6673a309bf3e52069b2006b1106c5923eb90580483c6575f6fb2c779909/images/whatsapp_image_20220920_at_52017_pm.jpeg"
																										     alt
																										     style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
																										     width="370"/>
																									</td>
																								...
																								<tr>
																									<td align="center"
																										...
																										<table border="0"
																										       ...
																										       role="presentation">
																											<tr>
																												<td style="padding:0;Margin:0;border-bottom:1px solid #fb8500;background:none;height:1px;width:100%;margin:0px"/>
																											</tr>
																										</table>
																									</td>
																								</tr>
																<tr>
																									<td align="center"
																										...
																										<p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;color:#666666;font-size:20px">
																											<?php echo $sumaryLeft1; ?>
																											<strong><?php echo $sumaryRight1; ?></strong>
																											<br>
																											<?php echo $sumaryLeft2; ?>
																											<strong><?php echo $sumaryRight2; ?></strong>
																											</p>
																										</td>
																									</tr>
																																</table>
																								...
																								<table cellpadding="0"
																									...
																									<tr>
																										<td align="center"
																										    class="es-m-txt-c"
																										    style="padding:0;Margin:0">
																											<!--[if mso]><a href="httphttp://localhost/posme/" target="_blank" hidden>
																											...
																											<!--[if !mso]>
																											<!-- -->
																											<span class="es-button-border-4 msohide es-button-border"
																											      style="border-style:solid;border-color:#2CB543;background:#67c977;border-width:0px;display:inline-block;border-radius:30px;width:auto;mso-hide:all">
																												<a href="httphttp://localhost/posme/"
																												   ...
																												   style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;border-style:solid;border-color:#67c977;border-width:10px 25px 10px 15px;display:inline-block;background:#67c977;border-radius:30px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center">
																													<img src="https://yjqvnr.stripocdn.email/content/guids/CABINET_2e7b5e7c419fb67c255cca2bf344a8df/images/41781618489806584.png"
																													     alt="icon"
																													     width="26"
																													     ...
																													     align="absmiddle"> proveedor: 8712-5827</a>
																												</span>
																												<!--<![endif]-->
																											</td>
																										</tr>
																	...
																	<tr>
																		<td align="center"
																			...
																			<table class="es-footer-body"
																				...
																				<tr>
																					<td align="left"
																					    style="Margin:0;padding-left:20px;padding-right:20px;padding-top:25px;padding-bottom:25px;border-radius:0px 0px 10px 10px;background-color:#00628e"
																					    bgcolor="#00628e">
																						<table cellpadding="0"
																						       cellspacing="0"
																						       width="100%"
																												...
																												<table cellpadding="0"
																													...
																													<tr>
																														<td align="center"
																															...
																															<a target="_blank"
																															   href="https://www.facebook.com/people/Posme-Nicaragua/100085567321314"
																															   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:14px">
																																<img title="Facebook"
																																     src="https://yjqvnr.stripocdn.email/content/assets/img/social-icons/circle-white/facebook-circle-white.png"
																																     alt="Fb"
																																     width="32"
																																     style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"/>
																															</td>
																															<td align="center"
																															    ...
																															    style="padding:0;Margin:0">
																																<a target="_blank"
																																   href="https://www.youtube.com/@posme6209"
																																   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:14px">
																																	<img title="Youtube"
																																	     src="https://yjqvnr.stripocdn.email/content/assets/img/social-icons/circle-white/youtube-circle-white.png"
																																	     alt="Yt"
																																	     width="32"
																																	     style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"/>
																																</td>
																																	...
																																	<td align="center"
																																		...
																																		<a target="_blank"
																																		   ...
																																		   style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#CCCCCC;font-size:12px">
																																			<img src="https://yjqvnr.stripocdn.email/content/guids/CABINET_09023af45624943febfa123c229a060b/images/7911561025989373.png"
																																			     alt
																																			     width="125"
																																			     style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"/>
																																		</td>
