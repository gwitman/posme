	...
	$(document).ready(function(){		
		...
		$(document).on("click","#btnEdit",function(){
			...
			if(objRowTableListView != undefined){
				...
				window.location	= "<?php echo site_url(); ?>app_accounting_level/edit/companyID/"+data[0]+"/accountLevelID/"+data[1];
			}
			else{
			...
			if(objRowTableListView != undefined){
				...
				fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
					...
					$.ajax({									
						...
						dataType    : 'json',
						type        : 'POST',
						url  		: "<?php echo site_url(); ?>app_accounting_level/delete",
		...
		$(document).on("click","#btnNuevo",function(){
			fnWaitOpen();
			window.location	= "<?php echo site_url(); ?>app_accounting_level/add.aspx";
		});
	});
