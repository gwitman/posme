				...
				<script>	
					...
					$(document).ready(function(){					
						...
						$(document).on("click","#btnPrinter",function(){
							fnWaitOpen();							
							window.location = "<?php echo site_url(); ?>app_inventory_requestgeneral/viewRegister/companyID/<?php echo $objTM->companyID;?>/transactionID/<?php echo $objTM->transactionID;?>/transactionMasterID/<?php echo $objTM->transactionMasterID;?>";
						});
						//Archivos
						...
						$(document).on("click","#btnDelete",function(){
							fnShowConfirm("Confirmar..","Desea eliminar este Registro...",function(){
								...
								$.ajax({									
									...
									dataType    : 'json',
									type        : 'POST',
									url  		: "<?php echo site_url(); ?>app_inventory_requestgeneral/delete",
									...
									success:function(data){
										...
										if(data.error){
											...
											window.location = "<?php echo site_url(); ?>app_inventory_requestgeneral/index";
										}
									},
						...
						$(document).on("click","#btnAcept",function(){
								...
								$( "#form-new-transaction" ).attr("action","<?php echo site_url(); ?>app_inventory_requestgeneral/save/edit");
						...
						$(document).on("click","#btnImportDetailTransaction",function(){
							...
							$.ajax({									
								...
								dataType    : 'json',
								type        : 'POST',
								url  		: "<?php echo site_url(); ?>app_inventory_requestgeneral/getInfoImport",
