					 ...
					 <div class="col-lg-6">		
						<div class="panel" style="margin-bottom:20px;">
							...
							<div class="panel-body">
								<img class="img-featured" style="width:300px;height:200px" src="<?php echo base_url();?>/img/accounting-system-1.jpg">									
							</div><!-- End .panel-body -->
						</div><!-- End .widget -->								
					</div>
					<div class="col-lg-6">	
				...
				$(document).ready(function() {
						...
						$.ajax({									
							...
							dataType    : 'json',
							type        : 'POST',
							url  		: "<?php echo site_url(); ?>app_accounting_api/getInforDashBoards",							
