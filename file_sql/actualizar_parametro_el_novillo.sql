...
UPDATE tb_company SET NAME = 'Veterinaria el Novillo' , address = 'Multicentro las america, Managua Nicaragua' WHERE companyID = 2;
...
UPDATE tb_company_parameter, tb_parameter  SET 
	tb_company_parameter.value = 'flc_el_novillo'
WHERE
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
