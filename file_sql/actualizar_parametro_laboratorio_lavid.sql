...
UPDATE tb_company SET NAME = 'LABORATORIO LA VID' , address = 'Multicentro las america, Managua Nicaragua' WHERE companyID = 2;
...
UPDATE tb_company_parameter, tb_parameter  SET 
	tb_company_parameter.value = 'flc_labor_lavid'
WHERE
	tb_company_parameter.parameterID = tb_parameter.parameterID AND 
